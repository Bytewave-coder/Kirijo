      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-4 pt-5 pb-24">
        ...
        <div className="flex gap-3 mt-8">
          <button 
            ...
            className={cn(
              "flex-1 flex justify-center items-center gap-2 rounded-2xl py-3 font-head font-bold tracking-wider text-[14px]",
              w.archived ? "bg-accent/10 border border-accent/30 text-accent" : "border border-border2 text-text-sub"
            )}
          >
          ...
          <button 
            ...
            className="flex-1 flex justify-center items-center gap-2 rounded-2xl py-3 font-head font-bold tracking-wider text-[14px] bg-danger/10 border border-danger/30 text-danger"
          >
...
export function SettingsScreen() {
  ...
  const themes = ['dark', 'midnight', 'forest', 'blossom'] as const;
        ...
        <div className="bg-surface border border-border rounded-2xl overflow-hidden mb-5">
          <div className="p-4 border-b border-border">
            ...
            <div className="flex gap-2">
              {themes.map(t => (
                <button key={t} onClick={() => updateSettings({ theme: t })} className={cn("flex-1 py-2 rounded-xl text-[13px] border transition-all capitalize", settings.theme === t ? "bg-accent-dim border-accent/40 text-accent" : "bg-surface2 border-border2 text-text-sub")}>{t}</button>
              ))}
            </div>
          </div>
          <div className="p-4">
